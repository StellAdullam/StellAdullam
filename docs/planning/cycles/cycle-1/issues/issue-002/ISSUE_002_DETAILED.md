...
This issue establishes the persistence layer for the StellAdullam DeFi RWA API using PostgreSQL and Drizzle ORM. Drizzle provides a TypeScript-first approach with excellent performance and type safety.
...
DATABASE_URL=postgresql://user:password@localhost:5432/stelladullam_defi
DATABASE_POOL_MIN=2
