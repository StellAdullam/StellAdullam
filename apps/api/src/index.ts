...
app
  .use(
    swagger({
      documentation: {
        info: {
          title: 'StellAdullam API',
          version: '1.0.0',
          description:
            'Backend API for StellAdullam — Real Estate Tokenization and DeFi Lending on the Stellar Blockchain',
        },
      },
    }),
  )
...
console.log(`🚀 StellAdullam API is running on port ${process.env.PORT || 3001}`);
